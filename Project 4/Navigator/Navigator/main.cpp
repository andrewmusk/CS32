...
void example1(const MapLoader& ml);

int main()
{
    Navigator nav;
    if(nav.loadMapData("/Users/andrewmusk/Documents/CS32/Project 4/Navigator/Navigator/mapdata.txt"))
    {
    ...
    {
        cout << "The direction is: " << directions[k].m_command << " " << directions[k].m_direction << " on " << directions[k].m_streetName << " for " << directions[k].m_distance << endl << endl;
    }
}
